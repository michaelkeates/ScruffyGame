...
<ul>
<li>Get “Scruff” from point A to point B within the time limit otherwise the player loses the game. 🗺️</li>
...
<details open="" class="details-reset border rounded-2">
  <summary class="px-3 py-2">
    ...
    <span aria-label="Video description scruffy.mp4" class="m-1">scruffy.mp4</span>
    <span class="dropdown-caret"></span>
  </summary>

  <video src="https://user-images.githubusercontent.com/103878560/275195816-9713a700-df5e-4525-bed2-5bd04fd33ee7.mp4" data-canonical-src="https://user-images.githubusercontent.com/103878560/275195816-9713a700-df5e-4525-bed2-5bd04fd33ee7.mp4" controls="controls" muted="muted" class="d-block rounded-bottom-2 border-top width-fit" style="max-height:640px; min-height: 200px">
